...
zuerst checken, dass der Master up to date ist. Dann kann man die branches mergen mithilfe von
...
Im Pflichtenheft steht drinnen, was alles gemacht
werden soll.
...
Umwelt "fun facts"
Datenmodell ihm schicken, vor nächster Woche
...
IMPORTANT: Stütz ist zufrienden, wenn wir uns weiterentwickeln und uns auskennen,
und an Projekten gearbeitet wurde
...
Wichtige Folien: 2, 3, 7, Agile Vorgehensmodelle, SCRUM, User Story, Rollen in Scrum,
14, 15, 16, 17, 18
...
Klassen auswöheln
Rechtsklick -> diagram -> show-diagram
-> show depenencies
...
NOTE: CRAD = Create Read Add Delete
